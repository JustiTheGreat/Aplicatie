...
public class GetProductsMagazin extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            ResultSet rs = statement.executeQuery("select * from product where magazin='" + magazin + "'");
