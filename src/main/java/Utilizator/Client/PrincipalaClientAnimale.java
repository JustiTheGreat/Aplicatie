...
public class PrincipalaClientAnimale extends Utillity {
    ...
    public void read() {
        try {
            ...
            String parameters = "?f1=" + buttons[0] + "&f2=" + buttons[1] + "&f3=" + buttons[2] + "&f4=" + buttons[3] + "&f5=" + buttons[4] + "&f6=" + buttons[5]
                    + "&f7=" + buttons[6] + "&s1=" + buttons[7] + "&s2=" + buttons[8] + "&s3=" + buttons[9] + "&s4=" + buttons[10];
