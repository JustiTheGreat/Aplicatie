...
public class PrincipalaClientMagazinePetshop extends Utillity {
    ...
    public void read() {
        try {
            ...
            String parameters = "?magazin=" + magazin_ales.getUsername() + "&f1=" + buttons[0] + "&f2=" + buttons[1] + "&f3=" + buttons[2]
